...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-lumen-model-drift-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-lumen-model-drift-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-lumen-model-drift-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-lumen_model_drift_loom-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
