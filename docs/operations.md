...
`lumen-model-drift-loom` is centered on ml utilities work in Haskell. The technical target is: Create a Haskell reference implementation for drift workflows, centered on event replay, fixture event logs, and golden state snapshots.
