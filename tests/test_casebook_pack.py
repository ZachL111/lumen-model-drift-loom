"""Regression checks for the lumen-model-drift-loom casebook."""
...
from casebook.harness import assert_expected, lumen_model_drift_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lumen_model_drift_loom_summary(), assert_expected())
